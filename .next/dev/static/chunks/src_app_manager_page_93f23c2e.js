...
"[project]/src/app/manager/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ManagerPage() {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "ManagerPage.useEffect": ()=>{
            fetch('/api/manager').then({
                "ManagerPage.useEffect": (res)=>res.json()
            }["ManagerPage.useEffect"]).then({
                "ManagerPage.useEffect": (data)=>{
                    setStats(data.stats || {
                        totalOrders: 0,
                        totalRevenue: 0,
                        totalItemsSold: 0
            ...
            }["ManagerPage.useEffect"]).catch(console.error);
        }
    }["ManagerPage.useEffect"], []);
    // Prepare data for the revenue line chart
    const revenueChart = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ManagerPage.useMemo[revenueChart]": ()=>{
            if (!orders.length) {
                return {
                    labels: [],
                    values: []
            ...
            const sorted = [
                ...
                "ManagerPage.useMemo[revenueChart].sorted": (a, b)=>new Date(a.createdAt || 0) - new Date(b.createdAt || 0)
            }["ManagerPage.useMemo[revenueChart].sorted"]);
            const labels = sorted.map({
                "ManagerPage.useMemo[revenueChart].labels": (order, index)=>order.createdAt ? new Date(order.createdAt).toLocaleTimeString([], {
                        hour: '2-digit',
                        minute: '2-digit'
                    }) : `#${index + 1}`
            }["ManagerPage.useMemo[revenueChart].labels"]);
            const values = sorted.map({
                "ManagerPage.useMemo[revenueChart].values": (order)=>Number(order.total || 0)
            }["ManagerPage.useMemo[revenueChart].values"]);
            return {
                labels,
                values
            };
...
_s(ManagerPage, "Xj7ga+lyC/o9X121As6Ddg3gPIQ=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "ManagerPage");
...
//# sourceMappingURL=src_app_manager_page_93f23c2e.js.map